 ...
 */
final class Version20240220091858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD site_rattachement_id INT DEFAULT NULL, ADD pseudo VARCHAR(255) NOT NULL, ADD poster_file VARCHAR(255) DEFAULT NULL, ADD sexe VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP site_rattachement_id, DROP pseudo, DROP poster_file, DROP sexe');
    }
}
