 ...
 */
final class Version20240220091750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, lieu_id INT DEFAULT NULL, site_id INT DEFAULT NULL, etat_id INT DEFAULT NULL, organisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_heure_debut DATETIME NOT NULL, duree VARCHAR(255) NOT NULL, date_limite_inscription DATE NOT NULL, nb_inscription_max INT NOT NULL, infos_sortie LONGTEXT NOT NULL, INDEX IDX_3C3FD3F26AB213CC (lieu_id), INDEX IDX_3C3FD3F2F6BD1646 (site_id), INDEX IDX_3C3FD3F2D5E86FF (etat_id), INDEX IDX_3C3FD3F2D936B2FA (organisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE participant ADD site_rattachement_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE participant ADD CONSTRAINT FK_D79F6B1167D5E16 FOREIGN KEY (site_rattachement_id) REFERENCES site (id)');
        $this->addSql('CREATE INDEX IDX_D79F6B1167D5E16 ON participant (site_rattachement_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE participant DROP FOREIGN KEY FK_D79F6B1167D5E16');
        ...
        $this->addSql('DROP INDEX IDX_D79F6B1167D5E16 ON participant');
        $this->addSql('ALTER TABLE participant DROP site_rattachement_id');
    }
}
